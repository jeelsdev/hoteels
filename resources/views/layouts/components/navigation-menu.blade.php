      ...
      <div class="flex justify-between items-center">
        <div class="flex justify-start items-center">
          ...
          <a href="" class="text-md font-semibold flex items-center lg:mr-1.5">
            <img src="https://www.casonadejerusalen.com/favicons/favicon.ico" class="mr-2 h-8 rounded-md" alt="Logo">
            <span class="hidden md:inline-block self-center text-lg font-bold whitespace-nowrap">La casona de Jerusalén</span> 
          </a>
        </div>
        <div class="flex">
          <x-apps.search position="top"/>
        </div>
        <div class="flex items-center">
            ...
            <a href="{{ url()->current() }}" target="_blank" class="sm:inline-flex ml-5 text-white bg-gradient-to-br from-pink-500 to-voilet-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-3 shadow-md shadow-gray-300 hover:scale-[1.02] transition-transform">
