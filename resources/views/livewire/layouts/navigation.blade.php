    ...
    <div class="py-1 px-3 lg:px-5">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center">
                ...
                <ul role="menu" class="absolute top-14 right-3 lg:top-16 lg:right-4 z-10 flex min-w-[180px] flex-col gap-2 overflow-auto rounded-md border border-gray-50 bg-white p-3 font-sans text-sm font-normal text-gray-800 shadow-lg shadow-gray-500/10 focus:outline-none {{ $open?'':'hidden' }}">
