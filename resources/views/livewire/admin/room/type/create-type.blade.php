<div class="block justify-between items-center mx-4 mt-4 bg-white rounded-sm p-5 sm:flex">
    <div class="mb-1 w-full">
        <x-apps.form submit="{{ $create?'save':'update' }}">
            <div maxWidth="2xl">
                <x-slot name="title">
                    {{ $create?'Agregar':'Editar' }} tipo de habitación
                </x-slot>
                <x-slot name="content">
                    <div class="mt-4 text-sm text-gray-600">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <x-input id="denomination" type="text" class="mt-1 block w-full" wire:model="denomination"/>
                ...
                <x-slot name="footer">
                    ...
                    @else
                        <x-apps.link href="{{ route('room.types') }}" wire:loading.attr="disabled" class="mr-5">
                            Cancelar
                        </x-apps.link>
                        <x-button class="ml-2" wire:loading.attr="disabled" type="submit">
                            Actualizar
