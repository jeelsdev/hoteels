<div class="mb-5 lg:flex">
            ...
            <div class="mb-1 w-full">
                <div class="block items-center sm:flex md:divide-x md:divide-gray-100">
                    <div class="relative mt-1 w-full xl:w-96">
                        <x-apps.input wire:model.live="search" placeholder="Buscar por empresa">
                        </x-apps.input>
                    </div>
                ...
                @foreach ($tours as $tour)
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="px-4 py-1 lg:px-5 lg:py-2 space-x-2 whitespace-nowrap flex">
                            <button wire:click="$dispatch('editTour', {id: {{ $tour->id }}})" class="block">
    ...
    <div class="lg:w-1/3">
       <livewire:admin.service.tour.create-tour/>
    </div>
</div>
