<div class="mb-5 lg:flex">
            ...
            <div class="mb-1 w-full">
                <div class="block items-center sm:flex md:divide-x md:divide-gray-100">
                    <div class="relative mt-1 w-full xl:w-96">
                        <x-apps.input wire:model.live="search" placeholder="Buscar por producto">
                        </x-apps.input>
                    </div>
            ...
            @else
                @foreach ($xtras as $xtra)
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="px-4 py-1 lg:px-5 lg:py-2 text-base font-medium text-gray-900 whitespace-nowrap">
                            {{ $xtra->created_at->format('d/m/Y') }}
                        </td>
                        <td class="px-4 py-1 lg:px-5 lg:py-2 space-x-2 whitespace-nowrap flex">
                            <button wire:click="$dispatch('editXtra', {id: {{ $xtra->id }}})" class="block">
    ...
    <div class="lg:w-1/3">
       <livewire:admin.service.xtra.create-xtra/>
    </div>
</div>
